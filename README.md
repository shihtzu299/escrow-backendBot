...
Frontend Git Repo: https://github.com/shihtzu299/AfriLance-Frontend
...
```bash
git clone https://github.com/[your-username]/afrilance-backend.git
cd afrilance-backend
npm install
cp .env.example .env
# Fill .env: PRIVATE_KEY, RPC_BNB, RPC_BASE, SUPABASE_URL, SUPABASE_KEY, TELEGRAM_BOT_TOKEN, etc.
npm run dev
